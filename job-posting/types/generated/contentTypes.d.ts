...
export interface ApiJobSearchJobSearch extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    jobStatus: Schema.Attribute.Enumeration<['Open', 'Closed', 'Filled']>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::job-search.job-search'
    > &
      Schema.Attribute.Private;
    location: Schema.Attribute.String;
...
export interface ApiJobJob extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    jobStatus: Schema.Attribute.Enumeration<
      ['Draft', 'Published', 'Filled', 'Expired']
    > &
      Schema.Attribute.Required &
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::job-search.job-search': ApiJobSearchJobSearch;
